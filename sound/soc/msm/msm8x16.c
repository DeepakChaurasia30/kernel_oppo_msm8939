...
#define MAX_SND_CARDS 4 //VENDOR_EDIT
...
#define OPPO_MM_KEYLOG

#ifndef VENDOR_EDIT
//John.Xu@PhoneSw.AudioDriver, 2015/10/23, Add for MM key log
#define OPPO_MM_KEYLOG
#ifdef OPPO_MM_KEYLOG
...
static struct switch_dev keylog_swthdev = {
    .name = "mmkeylog",
    .print_name = mm_keylog_printname,
};
...
/*OPPO 2015-12-18 zhangping Add for dump log*/
static int dump_statue_track_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
...
static int dump_statue_track_put(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	...
	if (enable) {
		...
		if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK) {
			...
			ret = afe_set_lpass_clock(
					AFE_PORT_ID_QUATERNARY_MI2S_RX,
					&mi2s_rx_clk);
#ifdef VENDOR_EDIT //Jianfeng.Qiu@Multimedia.Audio, 2015/06/08, Add for quat i2s patch
		} else if (substream->stream == SNDRV_PCM_STREAM_CAPTURE) {
...
static const struct soc_enum msm_snd_enum[] = {
	...
	/*OPPO 2015-12-18 zhangping Add for dump log*/
	#ifdef VENDOR_EDIT
    SOC_ENUM_SINGLE_EXT(2, dump_status_pa_text),
	#endif
	/*OPPO 2015-12-18 zhangping Add for dump log end*/
...
static const struct snd_kcontrol_new msm_snd_controls[] = {
	...
	/*OPPO 2015-12-18 zhangping Add for dump log*/
	#ifdef VENDOR_EDIT
    SOC_ENUM_EXT("Headset Insert Dump", msm_snd_enum[5],
		dump_statue_track_get, dump_statue_track_put),	
	#endif
	/*OPPO 2015-12-18 zhangping Add for dump log end*/
};
...
/*xiang.fei@Multimedia, 2014/09/01, Modify for headset*/
	...
	btn_high[4] = 137;
#else
/*LiLe@Prd6.BasicDrv.Audio, 2016/08/12, Modify for 15309 selfiestick*/
...
/*ping.zhang@Multimedia, 2015/06/10, Modify for selfiestick*/
   if (is_project(OPPO_15009) || is_project(OPPO_15035) || is_project(OPPO_15037)||is_project(OPPO_15029)||is_project(OPPO_15109))
   {
		btn_low[4] = 175;
   }
/*lile@EXP.BasicDrv.Audio, 2015-07-07, add for clone 15018 15011 and 15022, 15085 clone 15011, (15089) = 15018 (15062) = 15011 (15081) = 15022*/
   ...
   {
        btn_low[4] = 90;/*LiLe@Prd6.BasicDrv.Audio, 2016/08/15, Modify for 15399 selfiestick*/
   }
	else
	{
		btn_low[4] = 140;
	}
/*ping.zhang@Multimedia, 2015/06/10, Modify for end*/
 /*hanqing.wang@EXP.BasicDrv.Audio add for clone 15089 = 15018 15011 = 15062 and add the macor MSM_15062 and OPPO_15011 = OPPO_15018*/
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
    if (is_project(OPPO_15011) ||is_project(OPPO_15018) || is_project(OPPO_15085)) {
        btn_high[4] = 315; //Jianfeng.Qiu@AudioDriver 2014-05-11 add for selfiestick
    } else {
        btn_high[4] = 315; //John.Xu@AudioDriver 2014-03-26 add for selfiestick
    }
#endif
...
//     
    if (((pcb_ver_flag0_value | pcb_ver_flag1_value << 1 | pcb_ver_flag2_value << 2) == 0)) {
        ...
        pr_err("15009 hw is before EVT2 version\n");
    } else {
        is_15009_after_evt2 = true;
        pr_err("15009 hw is or after EVT2 version\n");
    }
}
#endif /* VENDOR_EDIT */
...
static int msm8x16_asoc_machine_probe(struct platform_device *pdev)
{
    ...
    pr_err("before call mutex_init\n");
    mutex_init(&keylog_mutex);
    pr_err("before call switch_dev_register\n");
...
//John.Xu@PhoneSw.AudioDriver, 2015/04/30, Add for 15009 headset compatible
	...
	if(is_project(OPPO_15035) || is_project(OPPO_15037)||is_project(OPPO_15029)||is_project(OPPO_15109)|| is_project(OPPO_15399))
	{
		mbhc_cfg.hs_ext_micbias = true;
