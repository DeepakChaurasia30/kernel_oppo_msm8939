...
#ifdef VENDOR_EDIT
extern int ts4621_reg_write(int on, int gain);
#endif
/*OPPO	2015-05-11, zhangping add for  end*/
...
#ifdef VENDOR_EDIT //Jianfeng.Qiu@Multimedia.Audio, 2015/05/26, Modify for compatible selfiestick
...
static void wcd_mbhc_set_and_turnoff_hph_padac(struct wcd_mbhc *mbhc)
{
	...
	* removal event to sync-up PA's state */
	...
	snd_soc_update_bits(codec, MSM8X16_WCD_A_ANALOG_RX_HPH_CNP_EN,
		    0x30, 0x00);
	#else
	if(is_project(OPPO_14051) || is_project(OPPO_15005) || is_project(OPPO_15057) || is_project(OPPO_15009) || is_project(OPPO_15035)||is_project(OPPO_15037)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399))
	{
				...
				enum snd_jack_types jack_type)
{
	...
	/*OPPO	2015-10-15, yuanyan add to support ICBC bank USB key start */
	/*zengling.wu@EXP.BaseDrv.Audio, 2016-04-06, add OPPO_15399 to enable micbias*/
	#ifdef VENDOR_EDIT 
	if(is_project(OPPO_15022)|| is_project(OPPO_15399)){
					 ...
					 enum wcd_mbhc_plug_type plug_type)
{
	...
	if (plug_type == MBHC_PLUG_TYPE_HEADPHONE) {
		...
		if (mbhc->mbhc_cfg->detect_extn_cable) {
			...
			pr_err("%s: setup mic trigger for further detection\n",
				 __func__);
...
static void wcd_correct_swch_plug(struct work_struct *work)
{
	...
	bool wrk_complete = false;
	bool is_pa_on;
	/*OPPO	2015-06-12, zhangping add for  slow insert headset*/
	s16 reg;
	/*OPPO	2015-06-12, zhangping add for  slow insert headset end*/
	u16 micbias2;
	...
	/*OPPO	2015-05-08, zhangping add for  pop noise*/
	#ifdef VENDOR_EDIT
	if(!(is_project(OPPO_15009) || is_project(OPPO_15035)||is_project(OPPO_15037)||is_project(OPPO_15022)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399)))
		wcd_enable_curr_micbias(mbhc, WCD_MBHC_EN_MB);
	else
	{
	/*OPPO	2015-06-12, zhangping add for  slow insert headset*/
	   ...
	   snd_soc_update_bits(codec,MSM8X16_WCD_A_ANALOG_MBHC_FSM_CTL,0xB0, 0xB0);
    /*OPPO	2015-06-12, zhangping add for  slow insert headset end*/
	}
	#endif
	/*OPPO 2015-05-08 zhangping add end*/
    ...
    if (is_project(OPPO_15009) || is_project(OPPO_15035) || is_project(OPPO_15037) || is_project(OPPO_15011) || is_project(OPPO_15085) || is_project(OPPO_15018) || is_project(OPPO_15022)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399)) {
        #ifdef VENDOR_EDIT
        //John.Xu@PhoneSw.AudioDriver, 2015/06/11, Add for Qcom patch for slow insert headset
            if (mbhc->btn_press_intr) {
...
/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */			
			if ((hph_count == 6) && ((is_project(OPPO_15011)) || (is_project(OPPO_15085)) || (is_project(OPPO_15009)) || (is_project(OPPO_15035))||(is_project(OPPO_15399)) || (is_project(OPPO_15018)) || (is_project(OPPO_15037)) || (is_project(OPPO_15022))||(is_project(OPPO_15029)||is_project(OPPO_15109))))
			{
		...
		else 
		{
			...
			*/
			...
			#endif /* VENDOR_EDIT */
			{
				...
				/*OPPO 2015-06-24 hanqing.wang Add for reason OPPO_15011 = OPPO_15018, 15062 OPPO_MSM_15062 */
	/*OPPO 2015-06-24 hanqing.wang Add for add OPPO_15085 = OPPO_15018, 15085 OPPO_MSM_15085 */					
                if (is_project(OPPO_15009) || is_project(OPPO_15035) || is_project(OPPO_15037) || is_project(OPPO_15085) || is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022)||is_project(OPPO_15029)||is_project(OPPO_15109)||is_project(OPPO_15399)) {
                    if(++headset_count == 2) {
                         goto report;
                    } else {
                        continue;
...
exit:
	...
	#endif
	/*OPPO 2015-07-03 zhangping add end*/
...
#ifndef VENDOR_EDIT //Jianfeng.Qiu@MultiMedia.Audio, 2015/07/13, Modify for print log
