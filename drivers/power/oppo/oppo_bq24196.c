...
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	if(is_project(OPPO_14037) || is_project(OPPO_14051) || is_project(OPPO_15057) ||
		is_project(OPPO_15009) || is_project(OPPO_15037) || is_project(OPPO_15085) || is_project(OPPO_15029))
...
int bq24196_chg_uv(struct opchg_charger *chip, u8 status)
{
	...
	*****************************************/
	if(is_project(OPPO_15035)||
		(is_project(OPPO_15109) && (get_PCB_Version() == HW_VERSION__10||get_PCB_Version() == HW_VERSION__12))||is_project(OPPO_15109))
	{
