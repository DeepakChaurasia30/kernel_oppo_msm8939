...
void opchg_check_lcd_onoff(struct opchg_charger *chip)
{
	...
	/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
		...
		else if ( is_project(OPPO_15085)) {  //chaoying.chen@EXP.BaseDrv.charge,2015/07/23 modify for 15085
		...
		else if (is_project(OPPO_15399))
		{
			...
			opchg_config_input_chg_current(chip, INPUT_CURRENT_LCD, LCD_ON_CHARGING_INPUT_CURRENT_15029);
			#ifdef OPPO_CMCC_TEST
			opchg_config_fast_current(chip, FAST_CURRENT_LCD, LCD_ON_CHARGING_FAST_CURRENT_15029);
			#endif
		}
	...
	/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
		...
		else if (is_project(OPPO_15399))
		{
			...
			opchg_config_input_chg_current(chip, INPUT_CURRENT_LCD, LCD_OFF_CHARGING_INPUT_CURRENT_15029);
			#ifdef OPPO_CMCC_TEST
			opchg_config_fast_current(chip, FAST_CURRENT_LCD, LCD_OFF_CHARGING_FAST_CURRENT_15029);
			#endif
		}
		else if(is_project(OPPO_15005) || is_project(OPPO_15025)){
			if(chip->driver_id == OPCHG_SMB358_ID)
...
/*huqiao@EXP.BasicDrv.Basic add for clone 15085*/
	if(is_project(OPPO_14005) || is_project(OPPO_14045)|| is_project(OPPO_14037)|| 
		is_project(OPPO_15011)|| is_project(OPPO_15057)|| is_project(OPPO_15018)|| 
		is_project(OPPO_15022)|| is_project(OPPO_15043)|| is_project(OPPO_15009)|| 
		is_project(OPPO_15037)|| is_project(OPPO_15029)|| is_project(OPPO_15035)|| 
...
void opchg_set_status(struct opchg_charger *chip,bool input_curr_set)
{
    ...
    if(is_project(OPPO_14005) || is_project(OPPO_14023) || is_project(OPPO_14037)|| is_project(OPPO_14045) || 
		...
		is_project(OPPO_14043) || is_project(OPPO_15005) || is_project(OPPO_15018) || 
		is_project(OPPO_15022) || is_project(OPPO_15043) || is_project(OPPO_15009) || 
		is_project(OPPO_15037) || is_project(OPPO_15029) || is_project(OPPO_15035) || 
		is_project(OPPO_15085) || is_project(OPPO_15109) || is_project(OPPO_15399))
	{
...
//Fuchun.Liao@Mobile.BSP.CHG.BSP enable bq24196 wdt after resume
	...
	else
	{
		if (opchg_chip != NULL && the_chip != NULL && opchg_chip->chg_present == true && 
			opchg_get_charger_inout() == 0 && !(is_project(OPPO_15029) && get_PCB_Version() == HW_VERSION__10)) 
		{
				...
				switch(vooc_start_step) {
            	    ...
            	    case OPCHG_VOOC_TO_FAST:
            	        ...
            	        if (opchg_get_prop_fast_chg_started(chip) == true) {
							...
							#ifdef OPPO_USE_FAST_CHARGER_RESET_MCU
							if((is_project(OPPO_15011) || is_project(OPPO_15018) || is_project(OPPO_15022)||
								is_project(OPPO_15043))&&(chip->fast_charger_reset_sign == false))
            	        	{
