...
#ifdef CONFIG_MACH_OPPO	//sjc add
...
//static struct qpnp_lbc_chip *the_chip = NULL;
...
//Fuchun.Liao@Mobile.BSP.CHG 2015-04-26 add to use pmic-irq for external charge-ic
	...
	if(is_project(OPPO_15005)||is_project(OPPO_15035)||is_project(OPPO_15109)||is_project(OPPO_15399))
		return IRQ_HANDLED;
...
static void determine_initial_status(struct qpnp_lbc_chip *chip)
{
	...
	if( is_project(OPPO_15005)||is_project(OPPO_15035) || is_project(OPPO_15109) || is_project(OPPO_15399)||
		(is_project(OPPO_15029) && get_PCB_Version() == HW_VERSION__10))
		return ;
